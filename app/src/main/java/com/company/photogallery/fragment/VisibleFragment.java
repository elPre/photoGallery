...
public class VisibleFragment extends Fragment {
    ...
    public void onStart() {
        ...
        IntentFilter intentFilter = new IntentFilter(Constant.ACTION_SHOW_NOTIFICATION);
        getActivity().registerReceiver(mOnShowNotification, intentFilter, Constant.PERM_PRIVATE, null);
